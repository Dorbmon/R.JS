...
func SwapData(engine *otto.Otto){
	...
	engine.Set("RJS_SECRET_TELLING",func(call otto.FunctionCall)otto.Value{
		fmt.Println("This is For My Girlfriend.If you can see this,please show this to Everyone to show that I love my Girlfriend so much")
		...
		fmt.Println("It has all been the past lifer.I will never have you.The time to say bye....")
		return otto.Value{}
	})
	return
}
